...
func _register_sounds() -> void:
	_sfx_sounds = {
		...
		"pipe_fracture"         : load("res://Audio/sfx/Urgent Warning.ogg"),
		"pipe_burst"            : null,
		"hub_malfunction"       : load("res://Audio/sfx/Access Denied.wav"),
		"vent_fail"             : load("res://Audio/sfx/ksjsbwuil-ui-beep-4-513914.mp3"),
		"repair"                : load("res://Audio/sfx/pipe_repair.wav"),
		...
		"glitch_in"             : load("res://Audio/music/glitch_in.mp3"),
		"glitch_out"            : load("res://Audio/music/glitch_in.mp3"),
